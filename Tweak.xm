...
- (void)finishedTest:(id)arg1 extraResults:(id)arg2 {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(30 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        // Căutăm fereastra principală a jocului într-un mod compatibil
        UIWindow *window = [UIApplication sharedApplication].keyWindow;
        
        if (window) {
            // Desenăm un punct roșu (Crosshair/ESP Test) ca strat extern
            // NU modificăm binarul original, deci NU dă crash
            ...
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"OneState Ultra" 
                message:@"Sistemul Ghost (Overlay) activat! Daca vezi punctul rosu si nu ai crash, am reusit." 
